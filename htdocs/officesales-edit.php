...
if($_SERVER['REQUEST_METHOD']=='POST') { //form handler part:
    ...
    $commentop = mysql_real_escape_string($_POST['commentop']);
      if ($id = intval($_POST['id'])) {
        $querypos="UPDATE $table SET cid='$cid',name='$name',phone='$phone',mail='$mail',ip='$ip',port_i='$port_i',port_r='$port_r',port_v='$port_v',pass_router='$pass_router',pass_reg='$pass_reg',po_reg='$po_reg',regions_id='$regions_id',dogovor_pr='$dogovor_pr',provider='$provider',provider_phone='$provider_phone',mask='$mask',gw='$gw',dnsone='$dnsone',dnstwo='$dnstwo',fullname='$fullname',speed='$speed',lan='$lan',nettools='$nettools',conset='$conset',numbbe='$numbbe',numbmeg='$numbmeg',modemgsm='$modemgsm',commentop='$commentop' WHERE id=$id";
      }
