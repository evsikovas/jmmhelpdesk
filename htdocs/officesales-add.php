...
<?php
  ...
  if($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    if (empty($name) && empty($phone) && empty($cid)) {
      ...
      $query = "INSERT INTO oplist VALUES (NULL,'$cid','$name','$phone','$ip','$port_i','$port_r','$port_v','$regions_id','$pass_router','$pass_reg','$po_reg','$mail','$dogovor_pr','$provider','$provider_phone','$mask','$gw','$dnsone','$dnstwo','$fullname','$speed','$lan','$nettools','$conset','$numbbe','$numbmeg','$modemgsm','$commentop')";
